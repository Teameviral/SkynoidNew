...
#Import Gudz
RUN wget https://raw.githubusercontent.com/TeamEviral/SkynoidNew/master/firebotmain.py
RUN wget https://raw.githubusercontent.com/TeamEviral/SkynoidNew/master/requirements.txt
#Start Fumkin
